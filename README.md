...
### 📡 V2Ray Config Updates via Telegram

You can receive **free and regularly updated V2Ray configurations** not only from this repository,  
but also directly through our Telegram bot.

🤖 **Telegram Bot:**  
https://t.me/AbdalV2rayBot
...
- Config list updates automatically every **15 minutes**
...
**هر 15 دقیقه به‌روزرسانی می‌شود.**

### 📡 به روزرسانی کانفیگ های V2Ray از طریق تلگرام

علاوه بر این ریپازیتوری، شما می‌توانید **کانفیگ های رایگان و به روز V2Ray** را  
مستقیما از طریق ربات تلگرام دریافت کنید.
...
- لیست هر **15 دقیقه** به‌صورت خودکار آپدیت می‌شود
